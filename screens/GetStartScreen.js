  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Start your green journey! Track eco-goals, reduce waste, and make a big impact with small steps. 🌱
      </Text>
      ...
      <Image source={require("../assets/img/getstart.png")} style={styles.bottomImage} />
    </View>
  );
};
