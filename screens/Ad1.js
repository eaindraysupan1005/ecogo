  ...
  return (
    <LinearGradient colors={['#6CEC7A', '#D8F8D3']} style={styles.container}>
      ...
      <Text style={styles.description}>
        Save energy and water to protect the planet! It reduces pollution, lowers your bills, and ensures resources for future generations. Every small effort counts!
      </Text>
