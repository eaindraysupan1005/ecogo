  ...
  return (
    <LinearGradient colors={['#6CEC7A', '#D8F8D3']} style={styles.container}>
      ...
      <Text style={styles.description}>
        Recycling reduces waste, keeps the planet clean, and saves natural resources by reusing paper, plastic, and metal. It also uses less energy, protecting the environment.
      </Text>
