            ...
            >
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <View style={styles.box}>
                        ...
                        <Text style={styles.text}>Participate in eco-friendly campaigns,
                    ...
                    <View style={styles.box}>
                        ...
                        <Text style={styles.text}>Start and organize eco-friendly campaigns,
                            invite participants, and make a positive impact on the environment.</Text>
                        <View style={styles.rowContainer}>
                            <TouchableOpacity>
