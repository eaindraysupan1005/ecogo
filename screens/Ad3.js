  ...
  return (
    <LinearGradient colors={['#6CEC7A', '#D8F8D3']} style={styles.container}>
      ...
      <Text style={styles.description}>
        Community actions unite people to make a difference! Teamwork solves problems like pollution and waste, creating a cleaner, greener, and healthier world for everyone.
      </Text>

      {/* Ad1 image below the text, larger and aligned to the left */}
      <Image source={require('../assets/A3.webp')} style={styles.adImage} />
