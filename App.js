...
const BottomTabs = () => {
  return (
    <Tab.Navigator screenOptions={{
        tabBarStyle: styles.tabBar, tabBarShowLabel: false, headerShown: false,
        tabBarActiveTintColor: '#3FC951', tabBarInactiveTintColor: 'black',
        tabBarIconStyle: {marginTop: 10}, }}>
      <Tab.Screen name="Home" component={HomeScreen} options={{ tabBarIcon: ({color, size = 24}) => (
        <FontAwesome5 name="home" size={size} color={color} /> ), }} />
      <Tab.Screen name="Leaderboard" component={LeaderboardScreen} options={{ tabBarIcon: ({color, size = 24}) => (
        <FontAwesome5 name="trophy" size={size} color={color} /> ), }} />
      <Tab.Screen name="Community" component={Community} options={{ tabBarIcon: ({color, size = 24}) => (
        <FontAwesome5 name="users" size={size} color={color} /> ), }} />
      <Tab.Screen name="Setting"  component={SettingPage} options={{ tabBarIcon: ({color, size = 24}) => (
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="GetStart">
        ...
        <Stack.Screen name="CampaignScreen" component={CampaignScreen} options={({navigation}) => ({
            header: () => ( <CustomHeader title="Check Your Campaign" navigation={navigation} backgroundColor="#D8F8D3" /> ), })} />
        ...
        <Stack.Screen name="FoodWaste" component={FoodWaste} options={({navigation}) => ({
            header: () => ( <CustomHeader title="Food Waste and Eating Habits" navigation={navigation} backgroundColor="#D8F8D3" /> ), })} />
        ...
        <Stack.Screen name="Sustainable" component={Sustainable} options={({navigation}) => ({
          header: () => ( <CustomHeader title="Sustainable Community Actions" navigation={navigation} backgroundColor="#D8F8D3" /> ), })}/>
        <Stack.Screen name="Recycling" component={Recycling} options={({navigation}) => ({
          header: () => ( <CustomHeader title="Recycling for Green Environment" navigation={navigation} backgroundColor="#D8F8D3" /> ), })}/>
